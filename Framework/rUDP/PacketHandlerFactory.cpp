...
typedef tr1::unordered_map<PacketHeader::PACKET_ID_TYPE,
		const PacketHandlerBase*> PACKET_HANDLER_MAP_TYPE;
...
const PacketHandlerBase &PacketHandlerFactory::getPacketHandler(
	...
	PACKET_HANDLER_MAP_TYPE::const_iterator it = PacketHandlerList.find(
			packet_id);
